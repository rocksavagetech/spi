...
verilog:
	...
	@$(SBT) "runMain tech.rocksavage.Main verilog --mode print --module tech.rocksavage.chiselware.SPI.SPI --config-class tech.rocksavage.chiselware.SPI.SpiConfig"

synth:
	@echo Synthesizing...
	@$(SBT) "runMain tech.rocksavage.Main synth --module tech.rocksavage.chiselware.SPI.SPI --techlib synth/stdcells.lib --config-class tech.rocksavage.chiselware.SPI.SpiConfig"

sta:
	@echo Running Timing Analysis...
	@$(SBT) "runMain tech.rocksavage.Main sta --module tech.rocksavage.chiselware.SPI.SPI --techlib synth/stdcells.lib --config-class tech.rocksavage.chiselware.SPI.SpiConfig --clock-period 5.0"